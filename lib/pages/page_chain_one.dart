...
class PageChainOne extends StatefulWidget {
  const PageChainOne({Key key}) : super(key: key);

  @override
  _PageChainOneState createState() => _PageChainOneState();
}

class _PageChainOneState extends SizeState<PageChainOne> {
  List<Coin> chains = [];
  String name;
  String pass;
  String wid;
              ...
              children: [
                Row(
                  children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(item.symbol,
                                style:
                                Theme.of(context).primaryTextTheme.headline3.merge(TextStyle(color: BeeColors.FF091C40, fontSize: SizeUtil.sp(14))),
                    ...
                    Checkbox(
                        value: (item.selected || item != null && item == selectCoin) ? true : false,
  ...
  _commitChecked() async {
    ...
    if (type == 'import') {
      ...
      Get.to(PageMnemonic(), arguments: {"name": name, "type": "create", "pass": pass, "chains": checked});
    }
  }
