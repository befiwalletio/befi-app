...
class ETH extends Chain {
  ...
  ETH() : super(symbol: "ETH", chain: "ETH") {
    if (Global.E_RPC.ETH != null) {
      this.chainId = Global.E_RPC.ETH.chainId;
      this.url = Global.E_RPC.ETH.url;
    } else {
      this.chainId = '1';
      this.url = 'https://mainnet.infura.io/v3';
    }
  }
