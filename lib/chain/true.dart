...
class TRUE extends Chain {
  String chainId = '';
  String url = '';

  TRUE() : super(symbol: "TRUE", chain: "TRUE") {
    if (Global.E_RPC.TRUE != null) {
      this.chainId = Global.E_RPC.TRUE.chainId;
      this.url = Global.E_RPC.TRUE.url;
    } else {
      this.chainId = '19330';
      this.url = 'https://rpc.truescan.network';
    }
  }
